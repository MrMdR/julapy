...
public:
	...
	inline ofxQuat() { _v[0] = 0.0f; _v[1] = 0.0f; _v[2] = 0.0f; _v[3] = 1.0f; }
	...
	inline ofxQuat& operator = (const ofxQuat& v) {  _v[0]=v._v[0];  _v[1]=v._v[1]; _v[2]=v._v[2]; _v[3]=v._v[3]; return *this; }
	
	inline bool operator == (const ofxQuat& v) const { return _v[0]==v._v[0] && _v[1]==v._v[1] && _v[2]==v._v[2] && _v[3]==v._v[3]; }
