...
//	glTexCoord2f(tex_t, 0);			glVertex3i(renderWidth+1, 0, 0);
//	glTexCoord2f(tex_t, tex_u);		glVertex3i(renderWidth+1, renderHeight+1, 0);
//	glTexCoord2f(0, tex_u);			glVertex3i(0, renderHeight+1, 0);
//	glEnd();
//	glPopMatrix();
//	
