...
#import "NawlzGardener02GLView.h"

@implementation NawlzGardener02GLView

- (void) appInit
{
    app = new NawlzGardener( NAWLZ_GARDENER_APP_INDEX_1 );
    
    img = new NawlzImage();
    [ self loadImage : @"gardener_bg_02_1024x768.png" : img ];
