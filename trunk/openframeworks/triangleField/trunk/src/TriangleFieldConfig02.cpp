...
void TriangleFieldConfig02 :: init()
{
	...
	fields[ 1 ].cutoff    = 0.5;
	fields[ 1 ].noiseXRes = 0.041;
	fields[ 1 ].noiseYRes = 0.00083;
	...
	fields[ 2 ].cutoff    = 0.5;
	fields[ 2 ].noiseXRes = 0.041;
	fields[ 2 ].noiseYRes = 0.00083;
	fields[ 2 ].noiseZRes = 0.0;
	fields[ 2 ].noiseXVel = 0.0;
	fields[ 2 ].noiseYVel = -0.01;
...
void TriangleFieldConfig02 :: update()
{
	...
	fields[ i ].noiseYVel	+= ( ( 0.05 * audioNorm ) - fields[ i ].noiseYVel ) * 0.3;
