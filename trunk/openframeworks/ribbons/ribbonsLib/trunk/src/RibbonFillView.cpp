...
void RibbonFillView :: setup( Ribbon *r )
{
	ribbon = r;
...
void RibbonFillView :: useRibbonGLitch( bool b )
{
	glitchItUp = b;
}

void RibbonFillView :: setRibbonGlitch( int *floatArray, int arrayLength )
{
