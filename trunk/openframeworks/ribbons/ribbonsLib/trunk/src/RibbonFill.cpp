...
void RibbonFill :: init()
{
	
}

void RibbonFill :: setLength( int length )
{
...
void RibbonFill :: setInitPosition( float x, float y, float z )
{
...
void RibbonFill :: setInitVelocity( float x, float y, float z )
{
	Ribbon :: setInitVelocity( x, y, z );
}

void RibbonFill :: setInitColor( float r, float g, float b, float a )
{
...
void RibbonFill :: addVelocity( float x, float y, float z )
{
...
void RibbonFill :: addColor( float r, float g, float b, float a )
{
