...
public:
	...
	ofEvent<bool>	playInCompleteEvent;
	ofEvent<bool>	playOutCompleteEvent;
	...
	virtual void update ()
	{
		...
		if( t > 1.0 )
		{
			...
			if( bShow )
			{
				...
				ofNotifyEvent( playInCompleteEvent, bPlayedIn, this );
			}
			else
			{
				bPlayedOut = true;
				
				ofNotifyEvent( playOutCompleteEvent, bPlayedOut, this );
			}
		}
