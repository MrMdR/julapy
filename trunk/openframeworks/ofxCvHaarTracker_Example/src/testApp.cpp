...
void testApp::draw()
{
	...
	while( haarTracker.hasNextHaarItem() )
	{
		...
		haarTracker.getHaarItemRectEased( haarRect );
		
		haarRect.x		*= sourceToSampleScale;
		haarRect.y		*= sourceToSampleScale;
		haarRect.width	*= sourceToSampleScale;
		haarRect.height	*= sourceToSampleScale;
