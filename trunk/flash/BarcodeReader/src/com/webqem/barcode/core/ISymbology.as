...
package com.webqem.barcode.core {
	...
	public interface ISymbology {
		...
		function hasValidCheckSum(data:IDecodedBarcodeData):Boolean;

		function decodeBarcode(data:IEncodedBarcodeData):IDecodedBarcodeData;

		function isValidEncoding(data:IEncodedBarcodeData):Boolean;
