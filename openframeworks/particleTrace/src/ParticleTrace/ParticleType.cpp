...
void ParticleType :: setFont ( ofTrueTypeFont* font )
{
    this->font = font;
}

void ParticleType :: setKerning( float value )
{
	kerning = value;
}

void ParticleType :: setup ()
{
    if( !font )
    {
	...
	for( int i=0; i<charactersTotal; i++ )
	{
		...
		string str = "";
		str += characters[ i ];
		characterRectangles.push_back( font->getStringBoundingBox( str, 0, 0 ) );
	}
...
void ParticleType :: initCharacterVertices()
{
...
void ParticleType :: initCharacterOutline()
{
	int vboTotal = 0;
	for( int i=0; i<charactersTotal; i++ )
	{
...
void ParticleType :: initCharacterFill()
{
	int vboTotal = 0; 
...
void ParticleType :: setRibbinColorArray( float *ribbonColorArray )
{
	ribbonColors		= ribbonColorArray;
	useRibbonColorArray	= true;
}

void ParticleType :: drawTypeOnRibbon( string copy, float *ribbonPositionArray, float *ribbonDirectionArray, int ribbonSize )
{
...
void ParticleType :: calcRibbonLengths()
{
...
int ParticleType :: getCharacterIndex ( int letter )
{
	for( int i=0; i<charactersTotal; i++ )
	{
...
void ParticleType :: drawLetterAsPlane( int letter, float xOffset, float yOffset )
{
...
void ParticleType :: drawLetterOutline ( int characterIndex )
{
...
void ParticleType :: drawLetterFill ( int characterIndex )
{
...
void ParticleType :: fill()
{
	useFill = true;
}

void ParticleType :: noFill()
{
	useFill = false;
}
