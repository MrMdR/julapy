...
//	assets->addImage( "ref_04",						xflPath + "ref/ref_04.png" );
	...
	assets->addImage( "timeline_futureBtn_a",		xflPath + "assets/timeline_futureBtn_a.png" );
	assets->addImage( "timeline_futureBtn_b",		xflPath + "assets/timeline_futureBtn_b.png" );
	
	assets->addImage( "timeline_tab_bg",			xflPath + "assets/timeline_tab_bg.png" );
...
//	assets->addImage( "timeline_tab_temp",			xflPath + "assets/timeline_tab_temp.png" );
	...
	assets->addImage( "timeline_playBtn_rain_0a",	xflPath + "assets/timeline_playBtn_rain_0a.png" );
	assets->addImage( "timeline_playBtn_rain_0b",	xflPath + "assets/timeline_playBtn_rain_0b.png" );
	assets->addImage( "timeline_playBtn_rain_1a",	xflPath + "assets/timeline_playBtn_rain_1a.png" );
	assets->addImage( "timeline_playBtn_rain_1b",	xflPath + "assets/timeline_playBtn_rain_1b.png" );
	assets->addImage( "timeline_playBtn_temp_0a",	xflPath + "assets/timeline_playBtn_temp_0a.png" );
	assets->addImage( "timeline_playBtn_temp_0b",	xflPath + "assets/timeline_playBtn_temp_0b.png" );
	assets->addImage( "timeline_playBtn_temp_1a",	xflPath + "assets/timeline_playBtn_temp_1a.png" );
	assets->addImage( "timeline_playBtn_temp_1b",	xflPath + "assets/timeline_playBtn_temp_1b.png" );
	...
	assets->addImage( "timeline_bar_marker_rain_a",	xflPath + "assets/timeline_bar_marker_rain_a.png" );
	assets->addImage( "timeline_bar_marker_rain_b",	xflPath + "assets/timeline_bar_marker_rain_b.png" );
	assets->addImage( "timeline_bar_marker_temp_a",	xflPath + "assets/timeline_bar_marker_temp_a.png" );
	assets->addImage( "timeline_bar_marker_temp_b",	xflPath + "assets/timeline_bar_marker_temp_b.png" );
	...
	assets->addImage( "popup_play_a",				xflPath + "assets/popup_play_a.png" );
	assets->addImage( "popup_play_b",				xflPath + "assets/popup_play_b.png" );
	...
	assets->addImage( "event_close_icon_a",			xflPath + "assets/event_close_icon_a.png" );
	assets->addImage( "event_close_icon_b",			xflPath + "assets/event_close_icon_b.png" );
	...
	assets->addSound( "click_sound",				xflPath + "sounds/click.mp3" );
