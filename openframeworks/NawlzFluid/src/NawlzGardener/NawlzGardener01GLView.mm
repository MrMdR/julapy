...
#import "NawlzGardener01GLView.h"

@implementation NawlzGardener01GLView

- (void) appInit
{
    app = new NawlzGardener( NAWLZ_GARDENER_APP_INDEX_0 );
    
    img = new NawlzImage();
    [ self loadImage : @"gardener_bg_01_1024x768.png" : img ];
