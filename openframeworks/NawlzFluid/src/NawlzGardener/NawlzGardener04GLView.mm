...
#import "NawlzGardener04GLView.h"

@implementation NawlzGardener04GLView

- (void) appInit
{
    app = new NawlzGardener( NAWLZ_GARDENER_APP_INDEX_3 );
    
    img = new NawlzImage();
    [ self loadImage : @"gardener_bg_04_1024x768.png" : img ];
